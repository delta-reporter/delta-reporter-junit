...
public class DeltaEventRegistrar implements TestLifecycleAware {
  ...
  public void onTestRunStarted(SuiteAdapter adapter) {
    ...
    try {
      this.configurator = (IConfigurator) Class.forName("com.deltareporter.config.DefaultConfigurator").newInstance();
      System.out.println("HELLO");
      // String project = (String) DeltaConfiguration.PROJECT.get(adapter);
      // project = !StringUtils.isEmpty(project) ? 
      // project :
      String project = this.DELTA_PROJECT;
